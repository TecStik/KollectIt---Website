...
function SecondHeader() {
  ...
  return (
    <>
        ...
        <div class="container">
          <div class="row justify-content-between gy-5">
            <div
              ...
              <h2 data-aos="fade-up" style={{ color: "#11366B" }}>Embrace KOLLECTIT for Shariah-Compliant Banking</h2>
          ...
          <div class="row gx-0">
            ...
            <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
              <div class="content">
                ...
                <br />
                <ul>
                  <li>Are you tired of the high costs, risks, and inefficiencies associated with traditional Islamic Banking and Financial Services Operations? Look no further! KOLLECTIT offers a groundbreaking solution powered by blockchain technology, poised to disrupt how IBFIs conduct transactions and contracts. Addressing Criticisms and Bringing True Sharia Compliance.</li>
                  <br />
                  <li> We understand the concerns surrounding Islamic Banks' operations, which often closely resemble conventional banking systems controlled by the State Bank of Pakistan. KOLLECTIT addresses these major criticisms, providing a viable alternative that aligns with the true spirit of Sharia law.</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="section-title">
          <h2><span></span>KOLLECTIT is aligned with the <br /> vision of digitalized Islamic Banking.</h2>
          <br />
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0 d-flex">
              <div class="row align-self-center gy-4">
                <p>As you can tell by the slideshow on The Monitor Above, KOLLECTIT enables the digitization of Islamic Banking with Transparency and Security. KOLLECTIT is a permissioned Blockchain network  of Islamic Financial Institutions (IFIs).</p>

                <div class="col-md-6" data-aos="zoom-out" data-aos-delay="200">
                  <div class="feature-box d-flex align-items-center">
                    <i class="fa fa-check"></i>
                    <h3><b>KOLLECTIT</b><p> provides more efficient transactional processes</p></h3>
                  </div>
                </div>
                ...
                <div class="col-md-6" data-aos="zoom-out" data-aos-delay="300">
                  <div class="feature-box d-flex align-items-center">
                    <i class="fa fa-check"></i>
                    <h3><b>KOLLECTIT</b><p>addresses  the key issues of Legacy Systems and  Procedures</p></h3>
                  </div>
                </div>
                ...
                <div class="col-md-6" data-aos="zoom-out" data-aos-delay="400">
                  <div class="feature-box d-flex align-items-center">
                    <i class="fa fa-check"></i>
                    <h3><b>KOLLECTIT</b><p>makes IFIs  increasingly competitive  for consumers.</p></h3>
                  </div>
                </div>
