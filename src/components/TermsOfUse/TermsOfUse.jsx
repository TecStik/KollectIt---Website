...
export default function TermsOfUse() {
  return (
    <>
      ...
      <br />
      <div class="PolyicContainer">
        <h2 id="logo-text" style={{ color: "black" }}>
          KollectIt - Terms of Use
          <p style={{ fontSize: 17 }}>Last updated August 17, 2023</p>
        </h2>

        <p id="Paragraph">
          <ul>
            <li>
              Kollectit is a mobile application that allows users to collect
              payments from customers or reimburse suppliers.
            </li>
            <li>
              The information provided on the app is not intended for
              distribution to or use by any person or entity in any jurisdiction
              where such distribution or use would be contrary to law or
              regulation.
            </li>
            <li>
              TecStik owns all intellectual property rights in the app,
              including the content and trademarks.
            </li>
            <li>
              Users are granted a non-exclusive, non-transferable, revocable
              licence to access the app and its content for personal,
              non-commercial use only.
            </li>
            <li>
              Users are prohibited from posting or uploading content that is
              illegal, harassing, harmful, defamatory, obscene, etc.
            </li>
            <li>
              TecStik may remove or edit any content that it considers harmful
              or in breach of the Terms of Use.
            </li>
            <li>
              If you believe that any material available on or through the app
              infringes upon your copyright, you should contact TecStik
              immediately.
            </li>
            <li>
              We do not take responsibility for any delays of text messages due
              to problems arising because of your cellular network provider.
            </li>
          </ul>
        </p>
        <h2>Key points:</h2>
        <ul>
          <li>The app is for personal, commercial use only.</li>
          <li>
            Users are prohibited from posting or uploading illegal, harmful, or
            offensive content.
          </li>
          <li>
            TecStik may remove or edit any content that it considers harmful or
            in breach of the Terms of Use.
          </li>
          <li>
            If you believe that any material available on or through the app
            infringes upon your copyright, you should contact TecStik
          ...
          <li>
            If any text messages are delayed due to your cellular network
            problems, we will not take responsibility
          </li>
        </ul>
        <p>
          Please contact us at if any problems regarding KollectIt’s usage
          arise:
        </p>

        <p>
          II Chundrigar Road Karachi, Sindh 00000 Pakistan
          <br />
          Phone: 02132442392
          <br />
          info@tecstik.com
...
//       <li>
//         We are TecStik ('Company', 'we', 'us', or 'our'), a company
//         registered in Pakistan at II Chundrigar Road, Karachi, Sindh 00000
//       </li>
//       <li>Platform Content</li>
//       <li>Disputes</li>
//       <li>Other Considerations</li>
//     </ol>
//     We operate the mobile application Kollectlt (the 'App'), as well as
//     any other related products and services that refer or link to these
//     legal terms (the 'Legal Terms" (collectivelv to the 'Services').
//     <br />
//     <br />
//     Collection of receivables become highly secure with Kollectit. The App
//     ensures your workers collect payments from your customers or reimburse
//     your suppliers with the exact amount the workers are entrusted with.
//     <br />
//     <br />
//     Download the app today and find out how Kollectit creates a seamless
//     process of payment. From both sides of the deal. KollectIt is free to
//     use with a transaction limit of 5.
//     <br />
//     <br />
//     7. Final Details
//     <br />
//     <br />
//     You can contact us by phone at 02132442392, email at info@tecstik.com,
//     or by mail to II Chundrigar Road, Karachi, Sindh 00000, Pakistan.
//     <br />
//     <br />
//     These Legal Terms constitute a legally binding agreement made between
//     you, whether personally or on behalf of an entity ('you'), and
//     TecStik, concerning your access to and use of the Services. You agree
//     that by accessing the Services, vou have read, understood. and agreed
//     to be bound bv all of these Legal Terms.
//     <br />
//     <br />
//     IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE
//     EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU CANNOT REGISTER
//     FOR USER ACCOUNT FOR KOLLECTIT.
//     <br />
//     <br />
//     <br />
...
//     </div>
//     <div className="d-flex justify-content-between">
//       <span>PURCHASES AND PAYMENT</span>
//       <span>9</span>
//     </div>
//     <div className="d-flex justify-content-between">
...
//     </div>
//     <div className="d-flex justify-content-between">
//       <span>CONTRIBUTION LICENCE</span>
//       <span>14</span>
//     </div>
//     <div className="d-flex justify-content-between">
//       <span>GUIDELINES FOR REVIEWS</span>
//       <span>15</span>
//     </div>
//     <div className="d-flex justify-content-between">
//       <span>MOBILE APPLICATION LICENCE</span>
//       <span>16</span>
//     </div>
//     <div className="d-flex justify-content-between">
//       <span>Use Licence</span>
//       <span>16</span>
//     </div>
//     <div className="d-flex justify-content-between">
...
//     (and various other intellectual propertv rights and unfair competition
...
//     non-transferable.
//     <br />
//     revocable licence to access the Services and/for:
//     <br />
//     <br />
//     <ol>
//       <li>
...
//       </li>
//       <li>Platform Information</li>
//       <li>Purchases and Subscription Information</li>
//       <li>
//         Solely for vour personal, non-commercial use or internal business
//         purposes
//       </li>
//       <li>Platform Content</li>
//       <li>Disputes</li>
...
//     </ol>
//     <br />
//     Except as set out in this section or elsewhere in our Leaal Terms. no
//     part of the Services and no Content or
//     <br />
//     republished. uploaded. bosted. bublicl displaved. encoded. translated.
//     transmitted. distributed. sold. licensed. or otherwise exploited for
//     anv commercial purpose whatsoever, without our express prior written
//     permission.
//     <br />
//     <br />
//     If vou wish to make use of the Services. Content. or Marks other than
//     as set out in this section or elsewhere in our Legal Terms. please
//     address your request to: info@tecstik.com.
//     <br />
//     <br />
//     If we ever grant you the permission to post. reproduce. or public
...
//     <br />
//     <br />
//     We reserve all rights not expressly granted to vou in and to the
...
//     careful prior to using our Services to understand the (a) rights you
//     agree to with us and (b) obligations vou have when vou post or upload
//     any content through the Services
//     <br />
//     Seneral
//     <br />
//     <br />
//     <b>2. Platform Information</b>
//     <br />
//     <br />
//     Submissions: By directly sending us any question, comment, suggestion,
//     idea, feedback, or other information about the Services
//     ('Submissions'), you agree to assian to us all intellectual propertv
//     rights in such Submission. You aaree that we shall own this Submission
//     and be entitled to its unrestricted use and dissemination
//     <br />
//     for an lawtul purpose. commercial or otherwise. without acknowledament
//     or compensation to vou.
//     <br />
//     <br />
//     <b>3. Purchases</b>
//     <br />
//     <b>4. Platform Content</b>
//     <br />
//     <b>5. Disputes</b>
//     <br />
//     <br />
...
//     functionality during which you mav create. submit. bost. displav.
//     transmit. bublish. distribute. or broadcast content and materials to
//     us or through the Services. including but not limited to text.
//     <br />
//     writings. video. audio. photographs. music. graphics. comments.
//     reviews. retina suggestions. personal information. or other material
...
//     <br />
//     <br />
//     You understand that Contributions mav be viewable bv other users of
//     the Services
//     <br />
//     <br />
//     <b>Final Details</b>
//     <br />
//     <br />
//     When vou post Contributions, vou grant us a licence (including use ot
//     vour name, trademarks, and logos): By posting an Contributions, vou
//     grant us an unrestricted, unlimited, irrevocable, perpetual,
//     non-exclusive, transferable, royalty-tree, tul-paid, worldwide right,
//     and licence to: use, copy, reproduce, distribute, sell. resell.
//     bublish. broadcast. retitle. store. publiclv perform. public displav.
//     reformat. translate. excert (in whole or in bart). and exploit your
//     Contributions
//     <br />
//     <br />
//     (including. without limitation: vour image. name. and voice) for a
...
//     sublicense the licences granted in this section. Our use and
//     distribution mav occur in media formats and through media channels
//     <br />
//     <br />
...
//     Services or making
//     <br />
//     Contributions accessible through the Services bv linking vour account
//     through the Services to any of vour social networking accounts.
//     <br />
//     <br />
...
//     <ul>
//       <li>
//         ﻿﻿confirm that vou have read and agree with our 'PROHIBITED
//         ACTIVITIES' and will not post. send. publish. upload. or transmit
//         through the Services an Submission nor post anv contribution that
//         is Illegal, harassing, hatetul, harmtul, detamator, obscene,
//         bulling, abusive, discrIminator, threatening to any person or
//         group, sexually explicIt, Taise, inaccurate, deceittul, or
//         misleading;
//       </li>

//       <li>
//         ﻿﻿to the extent permissible bv applicable law waive anv and all
//         moral rights to an such Submission and/or Contribution:
//       </li>

//       <li>
//         ﻿﻿warrant that an such Submission and/or Contributions are
//         oriainal to vou or that vou have the necessarv rights and licences
//         to submit such Submissions and/or contributions and that vou have
//         tull authority to grant us the above-mentioned rights in relation
//         to vour SubmissIons and/or Contributions: and
//       </li>
//     </ul>
//     • Warrant and represent that vour Submissions and/or contributions do
...
//     <br />
//     <br />
//     We mav remove or edit vour content: Although we have no obligation to
//     monitor an contributions. we shall have the right to remove or edit an
//     Contributions at any time without notice It in our reasonable opinion
//     we consider such contributions harmtul or in breach ot these Legal
//     lerms. It we remove or edit any such Contributions. we mav also
//     suspend or disable vour account and report vou to the authorities
//     <br />
//     <br />
...
//     any copyright you own or control. please immediatelv refer to the
...
//     <b>5. Disputes</b>
//     <br />
//     Ву using the Services, vou represent and warrant that:
//     <br />
//     (1) all registration information you submit will be true, accurate,
//     current, and complete;
//     <br /> (2) you will maintain the accuracy oT such Intormation and
//     prompty update sucn registration Intormation as necessary;
//     <br />
//     (3) you nave ine legal capacity and you agree to comply witn these
//     Leaal Terms:
//     <br />
//     (4) vou are not a minor in the urisdiction in which vou reside. or if
//     a minor. vou have received parental permission to use the Services:
//     <br />
//     (5) vou will not access the Services through automated or non-human
//     means. whether through a bot. script or otherwise:
//     <br />
//     (6) vou will not use the Services for an illeaal or unauthorised
//     purpose;
//     <br />
//     (7) vour use of the Services will not violate an applicable law or
//     regulation If vou provide anv information that is untrue. inaccurate.
//     not current. or incomplete. we have the riaht to susend or terminate
//     vour account and refuse an and all current or future use of the
//     Services (or an portion thereof). 6. Other Considerations
//     <br />
//     7. Final Details
//     <br />
//     <br />
...
//     <br />
//     We reserve the right to remove. reclaim. or change a username vou
//     select if we determine. in our sole discretion. that such a username
//     is inappropriate. obscene. Or otherwise objectionable.
//     <br />
//     <br />
//     <b>PURCHASES AND PAYMENT</b>
//     <br />
//     <br />
...
//     date, so that we can complete your transactions and contact vou as
//     needed. Sales tax will be added to the price of purchases as deemed
//     reduired b us. We mav chande prices at anv time. All Davments shall be
//     in US dollars.
//     <br />
//     <br />
//     You agree to pay all charges at the prices then in effect for your
//     purchases and any applicable shipping fees, and you authorise us to
//     charge your chosen payment provider for an such amounts upon placing
//     vour order. If vour order is subiect to recurrina charaes. then vou
//     consent to our charaina vour bavment method on a recurrina basis
//     without requiring vour prior approval tor each recurring charge. until
//     such time as vou cancel the applicable order.
//     <br />
//     We reserve the right to correct any errors or mistakes in pricing,
//     even it we have already requested or received payment.
//     <br />
//     <br />
//     We reserve the right to refuse an order placed through the Services.
//     We mav. in our sole discretion. limit or cancel quantities purchased
//     per person. per household. Oer organisation or per order. These
//     restrictions mav include orders placed or under the same customer
...
//     info@tecstik.com or call us at 02132442392
//     <br />
//     <br />
//     <b>PROHIBITED ACTIVITIES</b>
//     <br />
//     <br />
//     You mav not access or use the Services for a purpose other than that
//     for which we make the Services available.
//     <br />
//     <br />
//     The Services mav not be used in connection with any commercial
//     endeavours except those that are specifically endorsed or approved by
//     us. A user of the Services. vou agree not to:
//     <br />
//     <br />
//     <ul>
//       <li>
//         Systematically retrieve data or other content from the Services to
//         create or compile. directiv or indirectiv. a collection.
//         compilation. database. or director
//       </li>
//       <li>without written permission from us.</li>
//       <li>
...
//       </li>
//       <li>
//         Make user improvements or our support services or submit task
//         reports or abuse or misconduct
//       </li>
//       <li>
//         Use the Services in a manner inconsistent with an applicable laws
//         or regulations
//       </li>
//       <li>
...
//     <ul>
//       <li>
//         Engage in anv automated use of the system. Such as using scripts
//         to send comments or messages. or
//       </li>
//       <li>
...
//       </li>
//       <li>
//         ﻿﻿Upload or transmit (or attempt to unload or to transmit) an
//         material that acts as a passive or active
//       </li>
//       <li>
//         information collection or transmission mechanism, including
//         without limitation. clear graphics interchange formats ('gITS*),
//         1×1 piXels, web bugs, cookIes, or other similar devIces sometimes
//         reterred to as 'spyware' or 'passive collection mechanisms' or
//         'pcms").
//       </li>
//       <li>
//         ﻿﻿nterfere with. disrupt. or create an undue burden on the
//         Services or the networks or services connected to the Services.
//       </li>
//       <li>
//         ﻿﻿Harass, annoy, intimidate, or threaten any ot our employees or
//         agents engaged in providing any portion of the Services to vou
//       </li>
//       <li>
//         ﻿﻿Attempt to bypass anv measures of the Services designed to
...
//         to Flash, Phe, HIML, Javascript, or other
//       </li>
//     </ul>
//     <br />
//     <br />
...
//     <ul>
//       <li>
//         ﻿﻿Except as permitted bv applicable law. decipher. decompile.
//         disassemble. or reverse engineer anv of the software comprising or
//         in any wav making up a part of the Services.
//       </li>
//       <li>
...
//         cheat utty, scraper or offline reader that accesses the Services
//         or use or launch an unauthorised script or other software.
//       </li>
//       <li>
...
//       </li>
//       <li>
//         Make an unauthorised use of the Services. including collecting
...
//       </li>
//       <li>accounts of automated means or under case pretences</li>
//       <li>
//         Use the Services as part of anv effort to compete with us or
...
//       <li>
//         ﻿﻿We will not be responsible for any Text Messages delayed by
...
//     or personal information or other material (collectivelv,
...
//     When vou create or make available an Contributions. vou thereof
...
//         including but not limited to the convright. patent. trademark.
//         trade secret. or moral rights of anv third partv.
//       </li>
//       <li>
...
//         and everv identifiable individual, person in vour Contributions to
...
//         advertising promotional materials pvramid schemes, chain letters,
...
//         least sense of those terms) anv other
//       </li>
//       <li>
//         person and to promote violence against a specific person or class
//         of people.
//       </li>
//       <li>
...
//         are connected to race. national origin rule. gender, sexual
//         preference, or physical handicap.
//       </li>
//       <li>
//         ﻿﻿Your Contributions do not otherwise violate, or link to material
//         that vIolates, any provisIon OF these Legal Terms. or an
...
//     suspension of vour rights to use the Services
//     <br />
//     <br />
//     <b>CONTRIBUTION LICENCE</b>
//     <br />
//     <br />
//     By posting your Contributions to any part of the Services, vou
//     automatically grant, and you represent and warrant that you nave the
//     right to grant, to us an unrestricted, unlimited, irrevocable,
//     perpetual, non-exclusive transferable, royalty-free, fully-paid,
//     worldwide right, and licence to host, use, cop, reproduce, disclose,
...
//     including, without limitation, vour image and voice) for any purpose,
//     commercial, advertising, or otherwise, and to prepare derivative works
//     ot, Or incorporate into other works, such Contributions, and grant and
//     authorise sublicences of the foregoing. The use and distribution may
//     occur in any media formats and through anv media channels This licence
//     will apply to any form, media, or technology now known or hereafter
//     developed, and includes our use of vour name. companv name. and
//     franchise name. as applicable. and anv of the trademarks. marks. trade
//     names. logos. and personal and commercial images vou provide. You
//     waive all moral rights in vour Contributions. and vou warrant that
//     moral rights have not otherwise been asserted in vour Contributions We
...
//     <br />
//     <br />
//     <b>MOBILE APPLICATION LICENCE</b>
//     <br />
//     <br />
//     Use Licence If you access the Services via the App, then we grant you
...
//     an website or to send an unsolicited commercial email: or (9) use an
...
//     devices for use with the App. Apple and Android Devices
//     <br />
...
//     the Services: (1) the licence granted to vou for our App is limited to
...
//     and (ji) you are not listed on any US government list of prohibited or
...
//     are hosted in Pakistan. If you access the Services from any other
...
//     in Pakistan, then through your continued use of the Services, you are
//     transferring your data to Pakistan, and you expressly consent to have
//     your data transferred to and processed in Pakistan.
//     <br />
//     <br />
...
//     of Pakistan. TecStik and ourself irrevocably consent that the courts
//     of Pakistan shall have exclusive jurisdiction to resolve an dispute
...
//     expressly provided below) informally for at least five (5) days before
...
//     Karachi, Pakistan. The language of the proceedings shall be English.
...
//     there is no right or authoritv for an Dispute to be brought in a
//     burported representative capacitv on behalf of the general public or
//     any other persons.
//     <br />
//     Exceptions to Informal Negotiations and Arbitration
//     <br />
//     The Parties agree that the following Disputes are not subiect to the
//     above provisions concernina informal negotiations binding arbitration:
...
//     injunctive relief. If this provision is found to be illedal or
//     unenforceable. then neither Part will elect to arbitrate an Dispute
...
//     to the personal iurisdiction of that court
//     <br />
//     Privacy Policy
//     <br />
//     Cookie Policy
...
//     information on the Services at an time. without
//     <br />
//     опог nouce
//     <br />
...
//     <br />
//     DAMAGE OF ANY NATURE WHATSOEVER RESUITING FROM YOUR ACCESS TO AND USE
//     OF THE
//     <br />
//     SERVICES. (3)ANY UNAUTHORISED ACCESS TO OR USE OF OUR SECURE SERVERS
//     AND/OR ANY
//     <br />
...
//     Legal Terms; (4) any breach of your representations and warranties set
//     forth in these Legal Terms; (5) your violation of the rights of a
...
//     <br />
//     <br />
//     Kollectlt will not be responsible for any text messages delayed due to
//     the cellular network problems of your organisation members or yours.
//     <br />
//     <br />
//     <b>CONTACT US</b>
//     <br />
...
//     further information regarding use of the
//     <br />
//     Services, please contact us at: TecStik
//     <br />
//     I Chundrigar Road Karachi, Sindh 00000 Pakistan
//     <br />
//     Phone: <b>02132442392</b>
//     <br />
...
//         class="__cf_email__"
//         data-cfemail="660c091304140708480c07024d16140f1007051f26010b070f0a4805090b"
//       >
//         [email &#160;protected]
//       </a>
//     </li>
