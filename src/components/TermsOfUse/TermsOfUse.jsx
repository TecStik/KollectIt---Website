    ...
    <>
        ...
        >
          <div class="PolyicContainer">
            <div>
              ...
              >
                {/* <img
                  src="https://cdn-icons-png.flaticon.com/512/4436/4436485.png"
                  width="35"
                  height="35"
                  alt="Privacy Policy Logo"
                /> */}
                {/* <div id="logo-text">TERMS OF USE</div> */}
                <h2 id="logo-text">
                  TERMS OF USE
      ...
      <div class="PolyicContainer">
        ...
        <p id="Paragraph">
          ...
          <br />
          <br />
          Collection of receivables become highlly secure with Kollectit. The
          and ensures vour workers collect pavments from vour customers or
          reimburse vour suppliers with the exact amount the workers are
          entrusted with.
          <br />
          <br />
          Download the app todav and find out how Kollectit creates a seamless
          ...
          <br />
          Our intellectual property 2
          <br />
          Your use of our Services 2
          <br />
          Your submissions and contributions 3
          <br />
          Copyright infringement 5
          <br />
          USER REGISTRATION 5
          <br />
          PURCHASES AND PAYMENT 5
          <br />
          USER GENERATED CONTRIBUTIONS 7
          <br />
          CONTRIBUTION LICENCE 8
          <br />
          GUIDELINES FOR REVIEWS 9
          <br />
          MOBILE APPLICATION LICENCE 9
          <br />
          ADVERTISERS 10
          <br />
          SERVICES MANAGEMENT 10
          <br />
          COPYRIGHT INFRINGEMENTS 10
          <br />
          TERM AND TERMINATION 10
          <br />
          MODIFICATIONS AND INTERRUPTIONS 10
          <br />
          19. GOVERNING LAW 11
          <br />
          ...
          USER DATA 13
          <br />
          ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 13
          <br />
          MISCELLANEOUS 13
          <br />
          USAGE GUIDELINES 13
