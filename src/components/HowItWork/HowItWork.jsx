  ...
  return (
    <>
      <div>
        ...
        {/* <div id="CoursalImage">
          <img src={firstImage} alt="" srcset="" id="CoursalImageSize"/>
          <img src='https://static.pakwheels.com/2022/09/Ferrari-Purosangue-revealed-11-scaled.jpg' alt="" srcset="" id="CoursalImageMobileView"/>
        </div> */}
        {/* <img src={firstImage} alt="" srcset="" width="100%" style={{ alignItems: "center", marginLeft: "auto", marginRight: "auto", display: "block" }} /> */}
        ...
        <center>
          <div id="SlideImage">
            {/* Step-00 */}
            <Slide autoplay={false}>
              <section id="rider" class="howItWork d-flex align-items-center section-bg " >
                <div class="container mt-2" style={{ background: "#F0F2F5" }} id="ImageSliderRes">
                  <div class="row justify-content-between gy-5">
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                      <br />
        ...
        {/* <section id="rider" class="howItWork d-flex align-items-center section-bg" style={{ background: "white" }}>
          <div class="container">
            <div class="row justify-content-between gy-5">
              <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
        ...
        <center>
          <div id="SlideImage">
            {/* Step-00 */}
            <Slide autoplay={false}>
              <section class="howItWork d-flex align-items-center section-bg" id="rider">
                <div class="container" style={{ background: "#F0F2F5" }} id="">
                  <div class="row justify-content-between gy-5">
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                ...
                <div class="container mt-2" style={{ background: "#F0F2F5" }} id="ImageSliderRes">
                  <div class="row justify-content-between gy-5">
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                      <br />
                      <br />
                      <div class="content" style={{ textAlign: "left" }} id="ContentRider">
